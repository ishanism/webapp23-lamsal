...
updateSelectMovieEl.addEventListener("change", function () {
  ...
  if (movieId) {
    ...
    if (movie.director) updateSelectDirectorEl.value = movie.director.personId;
...
deleteFormEl["commit"].addEventListener("click", function () {
  ...
  if (confirm(`Do you really want to delete movie ${movieId} ${Movie.instances[movieId].title}?`)) {
